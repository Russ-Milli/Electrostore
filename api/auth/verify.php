...
require_once __DIR__ . '/../database_conn.php';  // only once
...
if (isset($_GET['token']) && !empty($_GET['token'])) {
    ...
    $db = getPDOConnection(); // use one consistent PDO variable
    
    // Check if token exists and is not expired (24 hours)
    $query = "SELECT id, username, email, email_verified, verification_token, created_at 
              FROM users 
        ...
        <div class="action-buttons">
            <?php if ($success): ?>
                ...
                <?php else: ?>
                    ...
                    <a href="public/index.php" class="btn-secondary">Go to Home</a>
                <?php endif; ?>
            <?php else: ?>
