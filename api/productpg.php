...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Product Not Found - ElectroStore</title>
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <p class="lead">The product you're looking for doesn't exist or the link is incorrect.</p>
...
try {
    ...
    if (!$product) {
        // Product ID exists but no product found
        header('HTTP/1.0 404 Not Found');
        ?>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <body>
            <div class="container mt-5">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center">
                        <h1>🔍 Product Not Found</h1>
                        <p class="lead">Product ID <?= $id ?> does not exist in our catalog.</p>
                        <a href="index.php" class="btn btn-primary">← Back to Products</a>
                    </div>
                </div>
            </div>
