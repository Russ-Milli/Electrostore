...
<head>
    ...
    <link rel="stylesheet" href="/Electrostore/public/css/style.css">
...
<div class="container py-1 px-5">
    <div class="bg-white p-4 px-5 rounded shadow-sm">
        ...
        <?php if (!$isLoggedIn): ?>
            <p class="text-danger mt-3">You must be <a href="auth/login.php">logged in</a> to complete your purchase.</p>
